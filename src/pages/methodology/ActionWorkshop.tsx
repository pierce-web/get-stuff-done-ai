...
const ActionWorkshop = () => {
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          details: "WhisperFlow or SuperWhisper - 'Typing is the old way; speech is the new way'"
        },
        {
          title: "Access Best Models",
          details: "ChatGPT Enterprise, Claude 3 Opus, or Gemini 1.5 Pro with thinking tokens maxed"
        },
        {
  ...
  const criticalTools = [
    {
      category: "Dictation",
      tools: ["WhisperFlow", "SuperWhisper"],
      importance: "Non-negotiable. Stop typing, start speaking.",
      icon: <Mic className="w-5 h-5" />
    },
    {
      category: "AI Models",
      tools: ["GPT-4o", "Claude 3 Opus", "Gemini 1.5 Pro"],
              ...
              <Card className={`${shadows.cardEffect} border-l-4 border-red-500`}>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    ...
                    GPT-4o and GPT-3.5 is the difference between magic and frustration. Always 
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                onClick={() => window.open("https://calendly.com/gsdatwork/action-workshop", "_blank")}
              >
